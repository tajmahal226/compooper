    ...
    <div className="flex flex-wrap gap-1.5">
      {visible.map(({ label, icon: Icon, strong }) => (
        <span
          ...
          className={
            strong
              ? "inline-flex items-center gap-1 rounded-lg bg-blue px-2 py-1 text-[11px] font-bold text-white"
              : "inline-flex items-center gap-1 rounded-lg bg-blue-soft px-2 py-1 text-[11px] font-bold text-navy"
          }
        >
