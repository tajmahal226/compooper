...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({ meta: [{ title: "Privacy — Compooper" }] }),
});
      ...
      <main id="main-content" className="site-wrap py-14">
        <article className="mx-auto max-w-[640px] rounded-xl border border-card-border bg-card p-8 shadow-(--shadow-sm) sm:p-10">
          ...
          <p className="text-muted">
            ...
            toilets. Compooper does not store a trail of where you have been. When you search for a
            place, only the search text is sent to Nominatim so we can move the map.
          </p>
          ...
          <p className="text-muted">
            Optional sign-in uses Google or X. We store an account identifier, your loo-roll
            ratings, optional notes, and live condition reports. Reports do not include your
            coordinates.
          </p>
          <h2 className="mt-6 mb-2 text-lg font-bold">What we don't do</h2>
          <p className="text-muted">
            No ads, no sale of personal data, no movement profiling. Children under 13 should not
            use the community features.
          </p>
          <h2 className="mt-6 mb-2 text-lg font-bold">Your rights</h2>
          <p className="text-muted">
            You can sign out at any time. To erase ratings and reports attached to your account,
            sign in and contact us via the help page — we will delete associated rows.
          </p>
        </article>
      </main>
      <SiteFooter />
